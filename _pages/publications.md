...
**At the end of this page, you can find the [full list of publications](#full-list-of-publications). All papers are also available on [Google Scholar]([https://arxiv.org/search/?searchtype=author&query=Allan%2C+M+P](https://scholar.google.com/citations?user=4OkEqtMAAAAJ&hl=en)).**
